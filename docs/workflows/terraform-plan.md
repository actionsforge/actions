...
OIDC terraform fmt/validate/plan for pull requests.

## Call

`actionsforge/actions/.github/workflows/terraform-plan.yml@main`
...
jobs:
  call:
    uses: actionsforge/actions/.github/workflows/terraform-plan.yml@main
    with:
